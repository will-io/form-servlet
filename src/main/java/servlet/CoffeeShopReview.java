...
out.println("        <head>");
out.println("                <title>Assignment 6</title>");
out.println("                <link rel=\"shortcut icon\" type=\"image/png\" href=\"gmu_coffee.png\">");
out.println("<style>");
...
out.println("<br>");
out.println("<br>");
out.println("<input type=\"checkbox\" name=\"Wifi\" value=\"wifi\"> Wifi &nbsp; &nbsp;");
out.println("<input type=\"checkbox\" name=\"Outlets\" value=\"outlets\"> Outlets &nbsp; &nbsp;");
out.println("<input type=\"checkbox\" name=\"Kid\" value=\"kid\"> Kid Friendly &nbsp; &nbsp;");
out.println("<input type=\"checkbox\" name=\"Reward\" value=\"reward\"> Reward Program &nbsp; &nbsp;");
out.println("<input type=\"checkbox\" name=\"Sofa\" value=\"sofa\"> Sofa(s)");
out.println("</p>");
out.println("");
out.println("<table>");
out.println("<tbody>");
...
out.println("<br>");
out.println("<textarea rows=\"5\" cols=\"50\" placeholder=\"Please enter your review here.\"></textarea>");
out.println("<tr>");
out.println("<br>");
